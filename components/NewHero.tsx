...
const NewHero = () => {
  ...
  {/* Top-Right Text */}
{/* <div className="absolute top-28 right-0 z-30 text-right bg-black/70 backdrop-blur-md px-4 py-3 rounded-md border border-[#a8905e] shadow-lg max-w-sm transition-all duration-900 animate-fadeInSlideDown">
  <p className="text-sm md:text-base uppercase tracking-wide text-white mb-1 font-semibold font-robotoCondensed">
    Solicitor of the Supreme Court of Victoria, Australia
  </p>
  <p className="text-sm md:text-base uppercase tracking-wide text-[#a8905e] font-semibold font-robotoCondensed">
